...
class TKMStyle: NSObject {
  ...
  static let explosionColor2 = UIColor(red: 230.0 / 255, green: 57.0 / 255, blue: 91.0 / 255,
                                       alpha: 1.0)
  static var radicalGradient: [CGColor] { return [radicalColor1.cgColor, radicalColor2.cgColor] }
  static var kanjiGradient: [CGColor] { return [kanjiColor1.cgColor, kanjiColor2.cgColor] }
  static var vocabularyGradient: [CGColor] {
    return [vocabularyColor1.cgColor, vocabularyColor2.cgColor]
  }

  static var lockedGradient: [CGColor] { return [lockedColor1.cgColor, lockedColor2.cgColor] }
  static var readingGradient: [CGColor] { return [readingColor1.cgColor, readingColor2.cgColor] }
  static var meaningGradient: [CGColor] { return [meaningColor1.cgColor, meaningColor2.cgColor] }
