...
public struct TKMSubject {
  ...
  public var hasSlug: Bool {return self._slug != nil}
  ...
  public var documentURL: String {
    get {return _documentURL ?? String()}
    set {_documentURL = newValue}
  }
  /// Returns true if `documentURL` has been explicitly set.
  public var hasDocumentURL: Bool {return self._documentURL != nil}
  /// Clears the value of `documentURL`. Subsequent reads from it will return its default value.
  public mutating func clearDocumentURL() {self._documentURL = nil}
  ...
  fileprivate var _japanese: String? = nil
  fileprivate var _radical: TKMRadical? = nil
  fileprivate var _kanji: TKMKanji? = nil
  fileprivate var _vocabulary: TKMVocabulary? = nil
}
...
extension TKMMeaning: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self._meaning)
...
extension TKMReading: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self._reading)
      case 2: try decoder.decodeSingularBoolField(value: &self._isPrimary)
      case 3: try decoder.decodeSingularEnumField(value: &self._type)
      default: break
      }
    }
...
extension TKMRadical: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self._characterImage)
      case 2: try decoder.decodeSingularStringField(value: &self._mnemonic)
      case 3: try decoder.decodeSingularBoolField(value: &self._hasCharacterImageFile_p)
      case 5: try decoder.decodeSingularStringField(value: &self._deprecatedMnemonic)
      default: break
      }
    }
  }
...
extension TKMKanji: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self._meaningMnemonic)
      case 2: try decoder.decodeSingularStringField(value: &self._meaningHint)
      case 3: try decoder.decodeSingularStringField(value: &self._readingMnemonic)
      case 4: try decoder.decodeSingularStringField(value: &self._readingHint)
      case 10: try decoder.decodeSingularStringField(value: &self._visuallySimilarKanji)
      default: break
      }
    }
  }
...
extension TKMVocabulary: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self._meaningExplanation)
...
extension TKMVocabulary.Sentence: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self._japanese)
      case 2: try decoder.decodeSingularStringField(value: &self._english)
      default: break
      }
    }
  }
...
extension TKMVocabulary.PronunciationAudio: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularInt64Field(value: &self._voiceActorID)
      default: break
      }
    }
  }
...
extension TKMSubject: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.readings.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.readings, fieldNumber: 6)
    }
    ...
    if let v = self._kanji {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 10)
    }
    if let v = self._vocabulary {
  ...
  public static func ==(lhs: TKMSubject, rhs: TKMSubject) -> Bool {
    ...
    if lhs._documentURL != rhs._documentURL {return false}
    if lhs._japanese != rhs._japanese {return false}
    if lhs.readings != rhs.readings {return false}
    if lhs.meanings != rhs.meanings {return false}
    if lhs.componentSubjectIds != rhs.componentSubjectIds {return false}
    if lhs.amalgamationSubjectIds != rhs.amalgamationSubjectIds {return false}
    if lhs._radical != rhs._radical {return false}
    if lhs._kanji != rhs._kanji {return false}
    if lhs._vocabulary != rhs._vocabulary {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension TKMProgress: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 3: try decoder.decodeSingularBoolField(value: &self._meaningWrong)
      case 4: try decoder.decodeSingularBoolField(value: &self._readingWrong)
      case 5: try decoder.decodeSingularBoolField(value: &self._isLesson)
      case 6: try decoder.decodeSingularMessageField(value: &self._assignment)
      case 7: try decoder.decodeSingularInt32Field(value: &self._createdAt)
      case 8: try decoder.decodeSingularInt32Field(value: &self._meaningWrongCount)
      case 9: try decoder.decodeSingularInt32Field(value: &self._readingWrongCount)
      default: break
      }
    }
  }
...
extension TKMUser: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularInt32Field(value: &self._level)
      case 3: try decoder.decodeSingularInt32Field(value: &self._maxLevelGrantedBySubscription)
      case 4: try decoder.decodeSingularStringField(value: &self._profileURL)
      case 5: try decoder.decodeSingularInt32Field(value: &self._startedAt)
      case 6: try decoder.decodeSingularBoolField(value: &self._subscribed)
      case 7: try decoder.decodeSingularInt32Field(value: &self._subscriptionEndsAt)
      case 8: try decoder.decodeSingularInt32Field(value: &self._vacationStartedAt)
      default: break
      }
    }
  }
...
extension TKMFormattedText: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeRepeatedEnumField(value: &self.format)
      case 2: try decoder.decodeSingularStringField(value: &self._text)
      case 3: try decoder.decodeSingularStringField(value: &self._linkURL)
      default: break
      }
    }
  }
...
extension TKMDataFileHeader: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeRepeatedMessageField(value: &self.subjectsByLevel)
      case 2: try decoder.decodeRepeatedUInt32Field(value: &self.subjectByteOffset)
      case 3: try decoder.decodeRepeatedInt32Field(value: &self.deletedSubjectIds)
      case 4: try decoder.decodeRepeatedInt32Field(value: &self.levelBySubject)
      default: break
      }
    }
  }
...
extension TKMLevel: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try decoder.decodeSingularInt32Field(value: &self._createdAt)
      case 6: try decoder.decodeSingularInt32Field(value: &self._passedAt)
      case 7: try decoder.decodeSingularInt32Field(value: &self._startedAt)
      case 8: try decoder.decodeSingularInt32Field(value: &self._unlockedAt)
      default: break
      }
    }
  }
...
extension TKMDeprecatedMnemonicFile: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeRepeatedMessageField(value: &self.subjects)
      default: break
      }
    }
  }
...
extension TKMDeprecatedMnemonicFile.Subject: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeRepeatedMessageField(value: &self.formattedDeprecatedMnemonic)
      default: break
      }
    }
  }
...
extension TKMVoiceActor: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularInt64Field(value: &self._id)
      case 2: try decoder.decodeSingularEnumField(value: &self._gender)
