...
class TypeOrderViewController: UITableViewController {
  ...
  var typeOrder: [TKMSubject.TypeEnum] {
    get { return hasLessonOrder ? Settings.lessonTypeOrder : Settings.reviewTypeOrder }
    set {
  ...
  private func adjustment(_ section: Int) -> Int {
    return section == 0 ? 0 : filteredTypeOrder.count
  }
  ...
  override func tableView(_: UITableView, canMoveRowAt _: IndexPath) -> Bool { return true }

  override func tableView(_: UITableView, heightForRowAt _: IndexPath) -> CGFloat { return 44 }

  override func tableView(_: UITableView, indentationLevelForRowAt _: IndexPath) -> Int { return 0 }
