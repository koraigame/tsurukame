...
extension FMResultSet {
  public func proto<T: SwiftProtobuf.Message>(forColumnIndex columnIndex: Int, _ value: T.Type) -> T? {
  ...
  public func proto<T: SwiftProtobuf.Message>(forColumn column: String, _ value: T.Type) -> T? {
